export const col_schema  = {
  ...
  "Scapular LT": {
    "Accel X": { data: [], csvX: "time", csvY: "Scapular LT Accel Sensor X (mG)" },
    "Accel Y": { data: [], csvX: "time", csvY: "Scapular LT Accel Sensor Y (mG)" },
    "Accel Z": { data: [], csvX: "time", csvY: "Scapular LT Accel Sensor Z (mG)" },
  ...
  "Scapular RT": {
    "Accel X": { data: [], csvX: "time", csvY: "Scapular RT Accel Sensor X (mG)" },
    "Accel Y": { data: [], csvX: "time", csvY: "Scapular RT Accel Sensor Y (mG)" },
    "Accel Z": { data: [], csvX: "time", csvY: "Scapular RT Accel Sensor Z (mG)" },
